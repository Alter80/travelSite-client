...
const Footer = () => {
    return (
        <div className='footer pb-5'>
            <Row className='pb-2'>
                <Col xs={12} md={3}>
                    <img src='https://i.ibb.co/Dtq3CHm/Green-and-Blue-Airplane-Travel-Logo-1.png' alt="" className='img-fluid' />
                ...
                <Col xs={12} md={3}>
                    <Link className='text-white text-decoration-none'> <strong><p className='footer-p border border-dark rounded p-3'> <small>About</small> <br /> <strong>Alt-Travel</strong> </p></strong></Link>
                    ...
                    <Link className='text-white text-decoration-none'> <strong><p className='footer-p border border-dark rounded p-3'>support@ alttravel.com</p></strong></Link>
                </Col>
            ...
            <Row className='pt-5 copyright'>
                <Col xs={12} md={6}>
                    <Row>
                        <Col xs={12} md={6}>
                            <small><p className='text-muted' >Copyright © 2022 Alt-Travel Socials LTD.</p> </small>
                        </Col>
                    </Row>
                </Col>
